...
#define N_CORR_NOISE 9 // a, m, flow_x, flow_y, z
#define U_A pow(0.5, 2) // Ruido medicion acelerometro
#define U_W pow(0.01, 2) // Ruido medicion giroscopio
#define U_FLOW pow(0.5, 2) // Ruido medicion flujo optico
#define U_RANGE pow(0.01, 2) // Ruido medicion distancia
...
typedef struct ofs_ekf {
    ...
    double FOV_OF; // FOV del sensor de OF
