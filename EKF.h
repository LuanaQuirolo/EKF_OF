...
#define N_OBS 9 // a, m, flow_x, flow_y, z
...
typedef struct ofs_ekf {
    ...
    /* Matrices Auxiliares */
    double aux[N_PROC_NOISE][N_STATES];
    double aux2[N_STATES][N_STATES];
    double aux3[N_STATES][N_STATES];
    double aux4[N_STATES][N_STATES];
    /* Vectores temporales */
    double temp[N_P];
    double temp2[N_OBS];
    double temp3[N_STATES];
    double temp4[N_STATES];
    double temp5[N_STATES];
