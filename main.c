...
int main() {
    ...
    for (int i = 0; i < 2; i++){
        ...
        meas.az = -9.81 + 0.08 * (2.0 * rand() / (RAND_MAX) - 1.0);
        meas.mx = -189/1090 + 0.001 * (2.0 * rand() / (RAND_MAX) - 1.0);
        meas.my = 313/1090 + 0.001 * (2.0 * rand() / (RAND_MAX) - 1.0);
        meas.mz = 12/1090 + 0.001 * (2.0 * rand() / (RAND_MAX) - 1.0);
